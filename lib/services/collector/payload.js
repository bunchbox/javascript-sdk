const generateObjectId = require('../../util/object-id')
...
// The clientId acts as identifier for the participation. Users of the SDK should
// probably use some kind of Session Identifier as `clientId` in order to allow
...
module.exports.createPayload = (type, params) => {
  ...
  const mainParams = encodeMainParams({ ...params, id, type, conversionId })
