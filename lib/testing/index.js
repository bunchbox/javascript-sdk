...
module.exports.assignUser = (experiment, stepIndex, clientId, params = {}) => {
  if (!bucketer.isAllocated(experiment, clientId)) {
    logger.debug('User is excluded from participating in the experiment')
    return false
  }
  ...
  return bucketer.pickVariant(experiment, { distributionKey: clientId, stepId })
}
